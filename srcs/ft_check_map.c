...
/*   Updated: 2025/06/01 09:38:59 by mait-all         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../Includes/so_long.h"

static void	ft_error(char **map, int i, int flag)
{
	char	*flag_msg[5];

	flag_msg[0] = ": One letter in these (EPC) "
		"is messed OR doubled in map!\n";
...
static int	ft_open_fd(char *file)
{
	int	fd;
